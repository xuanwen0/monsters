...
import 'package:monsters_front_end/pages/TEMP/tempAnnoyanceChat.dart';
...
Future<Map> getMapFromAccout(String account) async {
  Map socialResult = {};
  int index = 0;
...
class _SocialState extends State<Social> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Socials = getMapFromAccout(userAccount) as Map;
    print(Socials);
