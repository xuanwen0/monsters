...
class DestressWay {
  ...
  static List<DestressWay> fetchAll() {
    return [
      //1深呼吸 done
      DestressWay(1, '深呼吸', '臨床運動心理學家表示，這能幫助平靜壓力時刻混亂的心靈。將注意力放在呼吸上休息5分鐘...',
      ...
      //2聽音樂 done
      DestressWay(2, '聽音樂', '研究發現，人在緊張狀況下，聆聽音樂能使神經系統修復，還能降低血壓、心率與焦慮，無論...',
      ...
      //3運動 done
      DestressWay(3, '運動', '運動是極好的紓壓方式，根據哈佛醫學院的研究，放鬆心靈前必須先放鬆身體，藉由放鬆肢體...',
      ...
      //4手部按摩 done
      DestressWay(4, '手部按摩', '2008年發表的研究報告指出，只要五分鐘的手部按摩就能顯著降低壓力。雖然這項研究是...',
      ...
      //5與動物相處
      DestressWay(5, '與動物相處', '和動物相處絕對是減輕壓力很棒的方法。不僅能增加你的笑容，而且研究發現，會觸發身體...',
      ...
      //6喝花草茶
      DestressWay(6, '喝花草茶', '植物醫學教授說，花草茶是很棒的減壓劑，不妨試試貓薄荷、檸檬香蜂草、西番蓮花、啤酒花...',
      ...
      //7冥想
      DestressWay(7, '冥想', '每天練習幾分鐘的冥想有助緩解焦慮情緒，有研究表明，冥想時能使大腦的神經通路達到最平靜...',
      ...
      //8與自己獨處
      DestressWay(8, '與自己獨處', '智慧型手機或許帶來很多生活上的便利，但同時也制約人們的生活，每天滑手機讓神經緊繃...',
      ...
      //9洗熱水澡
      DestressWay(9, '洗熱水澡', '當你感到壓力大到爆時，洗洗個熱水澡有助於釋放緊繃壓力。根據美國國家健康研究院報告指出...',
      ...
      //10旅行
      DestressWay(10, '旅行', '旅行是最能放鬆身心、為自己充電方法，遠離塵囂與網路。曾有研究調查發現，沒休假、放假...',
      ...
      /*
      DestressWay(3, '運動', '運動介紹', 'assets/image/destress_item/way3.png', [
        DestressWayIntro('內文.content'),
        DestressWayIntro(""),
        DestressWayIntro(""),
        DestressWayIntro(""),
        DestressWayIntro(""),
