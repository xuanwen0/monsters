...
class new_fastTest3 extends StatelessWidget {
  new_fastTest3({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 402.0, start: 90.0),
            child: Text(
              '智慧型手機或許帶來很大的方便，但卻也制約人們的生活，每天滑手機讓神經緊繃，壓力也逐漸上升。\n根據《Quartz》報導，研究發現現代人應放下手機，享受與自我獨處，有助於更認識真我，強化同理心與刺激思考，當你花時間將焦點放在自己的感覺上，你將感到不那麼緊張，對生活也有很大的幫助。',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 27,
                color: const Color(0xffa0522d),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 280.0, end: 21.0),
            child:
                // Adobe XD layer: 'jitaku_taiki__relax…' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assetstemp/stay alone.png'),
                  fit: BoxFit.cover,
                ),
                borderRadius: BorderRadius.circular(8.0),
