...
class new_backgroundColor15 extends StatelessWidget {
  new_backgroundColor15({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.002, -0.507),
            child: SizedBox(
              width: 156.0,
              height: 32.0,
              child: Text(
