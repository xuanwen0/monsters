...
class new_backgroundColor3 extends StatelessWidget {
  new_backgroundColor3({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            margin: EdgeInsets.symmetric(horizontal: 0.0, vertical: 120.0),
          ),
          Pinned.fromPins(
