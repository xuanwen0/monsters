...
class new_backgroundColor6 extends StatelessWidget {
  new_backgroundColor6({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text:
                        '\n     在使用貘nsters的社群功能期間請務必遵守以下重要規範以維護您\n     自身安全以及其他使用者的使用權益。\n          •  禁止色情、暴力、血腥、恐怖等「有害兒少身心健康」相關\n              內容撰寫及討論\n          •  所有撰寫內容，包含文字、錄影、影片、照片、圖畫，以上\n              都須遵守第一點\n          •  尊重所有其他使用者所撰寫的言論 \n          •  禁止攻擊其他使用者\n          •  所有撰寫的內容禁止提及他人真實姓名、拍攝、錄製、繪製\n             他人肖像\n          •  任何踰越規範的行為都可能會導致撰寫內容遭到刪除或檢舉\n             甚至是收到警告等限制\n\n     ',
                  ),
                  TextSpan(
                    text: '七、隱私權保護政策之修正\n',
                    style: TextStyle(
                  ...
                  TextSpan(
                    text:
                        '\n     貘nsters的隱私權保護政策將因應需求隨時進行修正，修正後的條\n     款將更新於貘nsters的使用條款內。\n\n    ',
                  ),
                  TextSpan(
                    text: ' 八、聯繫管道\n',
                    style: TextStyle(
                  ...
                  TextSpan(
                    text:
                        '\n          •  對於貘nsters之隱私權政策有任何疑問，或有變更個人資料\n             之請求，請前往貘nsters抽屜裡的「個人資料」頁面進行資料\n             變更或者移除。\n          •  如果對於貘nsters App有任何使用上的建議，也可在App內\n             點擊抽屜裡的「使用回饋」來進行意見填寫。\n\n\n\n                       ',
                  ),
                  TextSpan(
                    text: '我已詳細閱讀完畢並且同意以上所有規範\n',
                    style: TextStyle(
                      fontWeight: FontWeight.w700,
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 12.0, middle: 0.2925),
            Pin(size: 13.0, end: 129.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
                border: Border.all(width: 1.0, color: const Color(0xff000000)),
