...
class new_backgroundColor5 extends StatelessWidget {
  new_backgroundColor5({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text:
                        '\n     •  貘nsters針對使用者的個人資料會進行必要的安全防護措施\n        (資料加密)，加以保護App及您的個人資料，只允許經過授\n        權的人員才能接觸您的個人資料，相關處理人員如有違反保\n        密義務，將會受到相關的法律處分\n     •  如因業務需要有必要委託其他單位提供服務時，貘nsters亦\n        會嚴格要求其遵守保密義務，並且採取必要檢查程序以確保\n        其將確實遵守\n      \n',
                  ),
                  TextSpan(
                    text: '四、網站對外的相關連結\n',
                    style: TextStyle(
                  ...
                  TextSpan(
                    text:
                        '\n貘nsters App提供其他網站的網路連結，您可經由貘nsters所提供\n的連結，點選進入其他網站。但該連結網站不適用貘nsters的隱私\n權保護政策，您必須參考該連結網站中的隱私權保護政策。\n\n',
                  ),
                  TextSpan(
                  ...
                  TextSpan(
                    text:
                        '貘nsters絕不會提供、交換、出租或出售任何您的個人資料給其他\n個人、團體、私人企業或公務機關，但有法律依據或合約義務者，\n不在此限。\n前項但書之情形包括不限於：\n     •  經由您書面同意\n     •  法律明文規定\n     •  為免除您生命、身體、自由或財產上之危險\n     •  與公務機關或學術研究機構合作，基於公共利益為統計或學\n        術研究而有必要，且資料經過提供者處理或蒐集者依其揭露\n        方式無從識別特定之當事人\n     •  當您在貘nsters上的行為，違反服務條款或可能損害或妨礙\n        貘nsters與其他使用者權益或導致任何人遭受損害時，經\n        貘nsters管理單位研析揭露您的個人資料是為了辨識、聯絡\n        或採取法律行動所必要者\n     •  有利於您的權益\n     •  貘nsters委託廠商協助收集、處理或利用您的個人資料時，\n        將對委外廠商或個人善盡監督管理之責\n',
                  ),
                ],
              ),
              textHeightBehavior:
